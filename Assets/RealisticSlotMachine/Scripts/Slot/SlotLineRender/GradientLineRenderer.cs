    ...
    public class GradientLineRenderer : SlotLineRenderer
    {
        ...
        public override void Create(LinesController linesController, LineBehavior lineBehavior)
        {
            ...
            for (int i = 0; i < hP.Count-1; i++)
            {
                ...
                lSRs[i] =  Creator.CreateSpriteAtPosition(null, lineSprites[i], mat, positions[i], sortingLayerID, sortingOrder);
            ...
            {
                SpriteRenderer sr = Creator.CreateSpriteAtPosition(null, dotSprite, mat, positions[i], sortingLayerID, sortingOrder+1);
